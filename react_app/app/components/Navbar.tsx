...
const Navbar: React.FC = () => {
 ...
 <nav className="navbar navbar-expand-lg">
      <div className="container">
        <a className="navbar-brand yoga-logo" href="#">Yoga</a>
        ...
        >
          <ul className="navbar-nav">
            <li className="nav-item position-relative nav-home-dropdown">
              <a className="nav-link active" href="#" id="homeDropdown">Home</a>
              <div
              ...
              >
                ...
                <a className="dropdown-item" href="#">Option 5</a>
              </div>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">Services 1</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">Services 2</a>
            </li>
